...
this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icon_create_account(3).png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Forgot-Your-Password-Icon-Large-Two(1).png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean b=c.userlogin(mail.getText(), pwd.getText());
         System.out.print(b);
        if(b){
//            Dao d=new DaoImpl();
            System.out.print(mail.getText());
            this.dispose();
//            ResultSet list=d.getList(mail.getText());
             
           frames.ENTRY e= new frames.ENTRY(mail.getText());
           e.setVisible(true);
            ...
            JOptionPane.showMessageDialog(null,"Invalid email or user name");
        }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        new frames.PASSWORD().setVisible(true);
        this.dispose();
   ...
   if(!emailValidator.validate(mail.getText().trim())||mail.getText().equals("")) 
      {
          mail.setBackground(new java.awt.Color(249, 217, 217)); 
